...
function AutomationFeatureLoading() {
  return (
    <div className="flex min-h-[320px] flex-1 animate-pulse items-center justify-center rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
      <div className="h-8 w-8 rounded-full border-4 border-slate-200 border-t-kedi-yellow dark:border-slate-700 dark:border-t-kedi-yellow" />
    </div>
  );
}
    ...
    const flowDataObj = {
      nodes: [
        ...
        },
        {
          id: "action",
          type: "action",
          data: { id: "send_zalo", name: "Gửi tin nhắn Zalo ZNS", desc: "Gửi thông báo chăm sóc", color: "bg-kedi-yellow", icon: "Z", previewType: "zalo" }
        }
      ],
      edges: [
      ...
      case "campaigns":
        return (
          <div className="flex-1 flex flex-col justify-center items-center py-20 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-6 text-center">
            <div className="w-16 h-16 bg-brand-50 dark:bg-kedi-yellow/10 text-kedi-navy rounded-full flex items-center justify-center mb-4">

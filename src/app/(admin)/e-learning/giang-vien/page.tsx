        ...
        <div className="border-b border-gray-100 px-5 py-4 dark:border-gray-800">
          <div className="relative max-w-xs">
            ...
            <input
              ...
              className="h-9 w-full rounded-xl border border-gray-200 bg-gray-50 pl-9 pr-4 text-sm outline-none focus:border-kedi-yellow focus:bg-white dark:border-gray-700 dark:bg-gray-800 dark:text-white"
            />
          </div>
        </div>

...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-99999 flex h-[52px] w-full items-center border-b border-kedi-navy/15 bg-white/95 backdrop-blur-xl dark:border-kedi-yellow/25 dark:bg-kedi-navy/95">
      <div className="flex w-full items-center justify-between gap-4 px-3 md:px-4 lg:px-5">
        ...
        <div className="flex h-8 items-center gap-1.5">
          <button
            className="flex h-8 w-8 items-center justify-center rounded-lg border border-kedi-navy/20 text-kedi-navy outline-none transition-[background-color,border-color,color] duration-150 hover:bg-brand-50 focus-visible:ring-3 focus-visible:ring-kedi-yellow/30 dark:border-white/20 dark:text-white dark:hover:bg-white/5 lg:hidden"
          ...
          {/* Profile Selector */}
          <div className="hidden h-8 items-center gap-1.5 rounded-lg px-2 text-sm font-medium text-kedi-navy select-none dark:text-white sm:flex">
            {profile?.avatar?.trim() ? (
              ...
              <span className="flex items-center justify-center w-4.5 h-4.5 rounded-full bg-kedi-yellow text-kedi-navy text-ui-micro font-bold">
                {avatarInitial}
              </span>
            )}
          ...
          {/* Team context */}
          <div className="hidden h-8 items-center gap-1.5 rounded-lg border-l border-kedi-navy/15 pl-3 pr-2 text-sm font-medium text-kedi-navy/70 select-none dark:border-white/15 dark:text-white/70 md:flex">
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="relative flex h-8 items-center">
              ...
              <input
                ...
                className="h-8 w-full rounded-lg border border-kedi-navy/15 bg-white py-0 pl-9 pr-11 text-sm text-kedi-navy outline-none transition-[background-color,border-color,box-shadow] duration-150 placeholder:text-kedi-navy/40 hover:border-kedi-navy/30 focus:border-kedi-yellow focus:bg-white focus:ring-3 focus:ring-kedi-yellow/20 dark:border-white/20 dark:bg-kedi-navy dark:text-white dark:placeholder:text-white/40 dark:hover:border-kedi-yellow/40 dark:focus:border-kedi-yellow"
              />
        ...
        <div className="flex h-8 items-center gap-2">
          <div className="flex h-8 items-center gap-1 border-l border-kedi-navy/15 pl-2 dark:border-white/15">
            {/* Help / Question Icon */}
            <button type="button" disabled aria-label="Trợ giúp" className="flex h-8 w-8 cursor-default items-center justify-center rounded-lg text-kedi-navy/40 opacity-70 dark:text-white/40">
          ...
          {/* User Dropdown */}
          <div className="flex h-8 items-center border-l border-kedi-navy/15 pl-2 dark:border-white/15">
            <UserDropdown />
          </div>
        </div>
      </div>

...
const AppSidebar: React.FC = () => {
                ...
                {nav.subItems.map((subItem) => (
                  <li key={subItem.name}>
                    ...
                    >
                      ...
                      <span className="menu-dropdown-label min-w-0 truncate">
                        {subItem.name}
                      </span>
  ...
  }, [pathname, isSubActive, visibleOthersItems]);
  ...
  return (
    <aside
      className={`font-sans fixed top-[52px] left-0 flex h-[calc(100dvh-52px)] flex-col bg-white text-kedi-navy transition-[width,padding] duration-200 ease-out z-50 border-r border-kedi-navy/15 dark:bg-kedi-navy dark:border-kedi-yellow/25 dark:text-white lg:top-0 lg:h-[100dvh]
        ${
    ...
    >
        ...
        >
          {isExpanded || isHovered || isMobileOpen ? (
            <div className="flex items-center gap-2 select-none">
              ...
              />
              <span className="text-lg font-bold tracking-tight text-[#0B2D5B] dark:text-white font-sans">
                kedi.media
              </span>
            </div>
          ) : (
      ...
      <div className="flex flex-col flex-1 overflow-y-auto no-scrollbar justify-between">
        <nav className="mb-5">
          <div className="flex flex-col gap-5">
            <div>
              <h2
                className={`mb-1.5 text-ui-micro font-semibold tracking-[0.08em] uppercase flex leading-[20px] text-kedi-navy/45 dark:text-white/45 ${
                  !isExpanded && !isHovered
                    ? "lg:justify-center"
                    : "justify-start"
                }`}
        ...
        <div className="mt-auto border-t border-kedi-navy/15 dark:border-white/15 pt-4 pb-6 space-y-2">
          {/* Cài đặt */}
          <Link
            href="/settings"
            prefetch={false}
      ...
      <button
        ...
        className="absolute top-[250px] -right-3 z-[60] hidden h-6 w-6 items-center justify-center rounded-full border border-kedi-navy/20 bg-white text-kedi-navy shadow-sm outline-none transition-[background-color,border-color,color,box-shadow] duration-150 hover:border-kedi-yellow hover:bg-brand-50 focus-visible:ring-3 focus-visible:ring-kedi-yellow/30 dark:border-kedi-yellow/30 dark:bg-kedi-navy dark:text-white dark:hover:bg-white/10 lg:flex"

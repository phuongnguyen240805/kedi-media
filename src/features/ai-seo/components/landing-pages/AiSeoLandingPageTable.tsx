                ...
                <td className="py-3.5 px-4">
                  <div className="flex flex-col max-w-sm">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-[10px] text-slate-500 dark:text-slate-400 font-medium hover:text-kedi-navy dark:hover:text-kedi-yellow transition flex items-center gap-1 mt-0.5 truncate"
                    >
                ...
                <td className="py-3.5 px-4 text-right">
                  <div className="flex items-center justify-end gap-1.5">
                    ...
                    <button
                      ...
                      className="text-slate-500 hover:text-kedi-navy dark:text-slate-400 dark:hover:text-kedi-yellow hover:bg-slate-100 dark:hover:bg-slate-800 p-1.5 rounded-lg transition disabled:opacity-30 cursor-pointer"
                      title="Kiểm toán SEO"
                    >

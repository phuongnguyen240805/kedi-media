        ...
        <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
          <div>
            <div className="flex items-center gap-1.5">
              <Sparkles className="w-4.5 h-4.5 text-kedi-navy animate-pulse" />
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-[11px] text-slate-500 dark:text-slate-400 font-medium hover:text-kedi-navy dark:hover:text-kedi-yellow transition underline break-all block mt-1"
            >
              {pageUrl}
            </a>
          </div>

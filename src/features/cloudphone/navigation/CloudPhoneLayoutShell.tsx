    ...
    <div className="flex flex-col md:flex-row bg-[#f8fafc] dark:bg-[#0c0d14] rounded-tr-2xl rounded-br-2xl rounded-bl-2xl overflow-hidden shadow-theme-xs h-[calc(100dvh-52px)] min-h-0">
      ...
      <div className="flex-1 min-w-0 flex flex-col bg-slate-100/40 dark:bg-[#0d0e15] relative">
        ...
        <button
          ...
          className="absolute -left-3 top-[320px] z-40 hidden md:flex items-center justify-center w-6 h-6 bg-kedi-yellow hover:bg-[#e0a800] text-[#3a5680] rounded-full shadow-md transition-all duration-200 cursor-pointer hover:scale-105 active:scale-95 border border-kedi-yellow"

    ...
    <div className="p-4 space-y-4 select-none">
      ...
      <div className="bg-white dark:bg-[#11121b] border border-gray-200 dark:border-gray-800 px-4 py-3 rounded-2xl flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-1.5 text-[11px] font-bold text-slate-400">
          ...
          <span>/</span>
          <span className="text-slate-700 dark:text-slate-400">File Manager</span>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-[#11121b] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="divide-y divide-slate-100 dark:divide-slate-800/60">
          {files.map((file) => (
            <div key={file.name} className="grid grid-cols-12 items-center p-4 text-xs font-semibold text-slate-700 dark:text-slate-400 hover:bg-slate-50/50 dark:hover:bg-slate-900/10 transition">
              ...
              <div className="col-span-2 text-slate-500 dark:text-slate-500">{file.size}</div>
              <div className="col-span-2 text-slate-500 dark:text-slate-500">{file.updated}</div>
          ...
          {files.length === 0 && (
            <div className="p-8 text-center text-slate-500 font-bold">No files yet</div>
          )}
        </div>
      </div>
    </div>

          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              {dataOptionItems.map((option) => (
                <label
                  key={option.key}
                  className="flex cursor-pointer select-none items-start gap-3 rounded-xl border border-gray-200 bg-gray-50/50 p-3.5 transition hover:bg-gray-50 dark:border-gray-800 dark:bg-gray-900/40 dark:hover:bg-gray-900"
                >
                  <input
                    type="checkbox"
                    ...
                    className="mt-0.5 h-4.5 w-4.5 cursor-pointer rounded text-brand-500 focus:ring-brand-400"
                  />
                  <div className="flex flex-col text-left">

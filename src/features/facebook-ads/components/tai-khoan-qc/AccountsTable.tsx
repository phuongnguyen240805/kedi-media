                      ...
                      <div className="flex flex-col text-left">
                        <span className="flex items-center gap-1.5 font-semibold text-gray-900 dark:text-white">
                          ...
                          {account.type === "BM" ? (
                            ...
                            <span className="rounded border border-slate-200 bg-slate-50 px-1 text-[9px] font-extrabold text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400">Cá nhân</span>
                          )}
                        </span>

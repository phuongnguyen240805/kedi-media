...
export default function UserProfileCard() {
  ...
  return (
    <div className="p-4">
      <div className="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3 py-1.5 select-none dark:border-gray-800 dark:bg-gray-900">
        <span className="relative flex h-8 w-8 shrink-0 overflow-hidden rounded-full border border-gray-200 dark:border-gray-800">
          {profile?.avatarUrl ? (
            ...
            <span className="flex h-full w-full items-center justify-center rounded-full bg-brand-50 text-sm font-bold text-brand-600 dark:bg-brand-900/50 dark:text-brand-300">
              {initials}
            </span>
          )}
        </span>

  ...
  return (
    <>
      ...
      <header className="adsmeta-top-header">
          ...
          {showConnection && (
            <div className="adsmeta-connection-popover" role="dialog" aria-label="Trạng thái kết nối Meta">
              <div className="adsmeta-connection-head">
                ...
                <div><b>{connectionLabel}</b><span>Workspace Kedi Demo</span></div>
        ...
        <Link href="/facebook-ads/manager" className="adsmeta-logo-link" aria-label="Kedi Facebook Ads">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={assetUrl("/images/facebook-ads/adsmeta-logo.svg")} alt="Kedi Facebook Ads" />
        </Link>

...
export default function AppCard({ app, onInstall, onUninstall, onOpen, onDetails }: AppCardProps) {
  ...
  const renderIcon = (name: string) => {
    switch (name) {
      case "website":
        return (
          <div className="w-12 h-12 text-kedi-navy dark:text-kedi-yellow flex items-center justify-center">
      ...
      case "fbads":
        return (
          <div className="w-12 h-12 text-kedi-navy dark:text-kedi-yellow flex items-center justify-center">
            <svg className="w-8 h-8 fill-current text-kedi-navy dark:text-kedi-yellow" viewBox="0 0 24 24">

    ...
    <div className="space-y-5 flex-1 max-w-3xl">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 font-medium mt-0.5">
          Liên kết Kedi org ↔ Medusa organization / sales channel (mock)
        </p>
      </div>
      ...
      <section className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 space-y-4">
        ...
        <dl className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
          ...
          <div>
            ...
            <dd className="font-medium text-kedi-navy">{organization.status}</dd>
          </div>
          <div>
            <dt className="text-[10px] font-bold uppercase text-slate-400">
              Account holder
      ...
      {editOpen && (
        ...
        >
          <CommerceField
            ...
            value={name}
            onChange={setName}
            placeholder="VD: Kedi — My Organization"
            required
          />
          <CommerceField

        ...
        {ORDER_TABS.map(([key, label]) => (
          <button
            ...
            className={`px-3 py-2 text-xs font-bold border-b-2 cursor-pointer transition ${
              tab === key
                ? "border-kedi-yellow text-kedi-navy dark:text-kedi-yellow"
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            ...
            {filtered.map((o) => (
              ...
              >
                <td className="px-4 py-3 font-semibold text-kedi-navy">
                  {o.displayId}
                </td>
            ...
            <div className="space-y-5 text-sm">
              ...
              <div className="pt-3 border-t border-gray-100 dark:border-gray-800 space-y-1">
                ...
                <div className="flex justify-between items-center pt-1">
                  ...
                  <span className="text-lg font-bold text-kedi-navy">

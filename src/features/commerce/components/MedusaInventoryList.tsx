      ...
      <td className="px-4 py-3">
        {canWrite ? (
          <input
            ...
            className="w-24 px-2 py-1 rounded-md text-sm border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-kedi-yellow/40"
          />
        ) : (
          <span
            className={
        ...
        <td className="px-4 py-3 text-right">
          <button
            ...
            className={`text-[11px] font-bold cursor-pointer ${
              dirty
                ? "text-kedi-navy hover:underline"
    ...
    <div className="space-y-5 flex-1">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-full sm:max-w-xs px-3 py-2 rounded-lg text-sm border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-slate-700 dark:text-slate-200 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-kedi-yellow/40"
        />

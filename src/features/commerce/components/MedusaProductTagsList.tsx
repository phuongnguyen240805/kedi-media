    ...
    <div className="space-y-5 flex-1">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 font-medium mt-0.5">
          Mock tag Medusa · màu là metadata phía Kedi
        </p>
      </div>
                ...
                {canWriteProduct && (
                  <td className="px-4 py-3 text-right space-x-3">
                    <button
                      type="button"
                      onClick={() => openEdit(t)}
                      className="text-[11px] font-bold text-kedi-navy hover:underline cursor-pointer"
                    >
                      Sửa
                    </button>
                    <button
      ...
      {draft && (
        <CommerceModal
          ...
          subtitle="Màu lưu ở Kedi (Medusa tag không có màu)"

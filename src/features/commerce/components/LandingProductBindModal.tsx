                      ...
                      return (
                        <button
                          ...
                          className={`text-left rounded-xl border px-3 py-2.5 transition cursor-pointer ${
                            active
                              ? "border-kedi-yellow bg-brand-50 dark:bg-kedi-yellow/10 dark:border-kedi-yellow"
                  ...
                  <>
                    ...
                    <section className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 focus:outline-none focus:border-kedi-yellow"
                      />
                            ...
                            return (
                              <label
                                ...
                                className={`flex items-center gap-3 px-3 py-2.5 cursor-pointer transition ${
                                  checked
                                    ? "bg-[#f4f7ff] dark:bg-kedi-yellow/10"
                              ...
                              >
                                <input
                                  ...
                                  className="w-4 h-4 rounded border-gray-300 text-kedi-navy focus:ring-kedi-yellow"
                                />
                                ...
                                <div className="text-sm font-bold text-kedi-navy whitespace-nowrap">

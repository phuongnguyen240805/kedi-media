                  ...
                  <tr>
                    <td colSpan={4} className="py-20 text-center select-none">
                      <div className="flex flex-col items-center justify-center space-y-3">
                        <div className="w-14 h-14 rounded-full bg-kedi-yellow text-kedi-navy dark:bg-kedi-yellow/10 dark:text-kedi-yellow flex items-center justify-center border border-kedi-yellow/20 dark:border-kedi-yellow/30">

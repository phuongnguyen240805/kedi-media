                  ...
                  >
                    <td className="py-4 px-6 text-xs font-medium text-slate-700 dark:text-slate-300">
                      <div className="flex items-center gap-2">
                        ...
                        {item.isDefault && (
                          <span className="px-2 py-0.5 text-ui-nano font-black text-kedi-navy bg-brand-50 dark:text-kedi-yellow dark:bg-kedi-yellow/10 rounded-sm uppercase tracking-wider">
                            Mặc định
                          </span>
                        )}
                      </div>

...
export const ReportsSidebar: React.FC<ReportsSidebarProps> = ({
  ...
  return (
    <div
      ...
      className="sub-sidebar-scroll relative w-full lg:w-[var(--sub-sidebar-width,185px)] bg-[#f4f4fa] dark:bg-[#13141f] border-r border-gray-200 dark:border-gray-800 flex flex-col flex-shrink-0 h-full overflow-y-auto overflow-x-hidden p-4"
    >
      <ResizeHandle
      ...
      <h2 className="text-lg font-bold text-slate-800 dark:text-white px-2 mb-4 flex items-center gap-2">
        <svg className="w-4 h-4 text-kedi-navy" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
      ...
      <div className="space-y-1.5">
        <div className="flex justify-between items-center px-3 mb-1">
          ...
          <button className="text-slate-400 hover:text-kedi-navy dark:hover:text-kedi-yellow transition cursor-pointer p-0.5 rounded hover:bg-gray-200/50 dark:hover:bg-white/5">
            <IconPlus size={12} />
          </button>
        </div>

...
function CheckMark() {
  return (
    <span className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-blue-100 text-kedi-navy">
      ...
      >
        ...
        <ul className="flex flex-col gap-1 border-b border-gray-200 pb-3 pt-4 dark:border-gray-800">
          ...
          <li>
            <DropdownItem
              onClick={openUpgrade}
              className="flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-kedi-navy text-theme-sm hover:bg-blue-50 hover:text-kedi-navy"
            >
        ...
        <div className="flex max-h-[calc(100dvh-24px)] min-h-0 bg-white text-slate-900 sm:max-h-[calc(100dvh-40px)]">
          <aside className="hidden w-[250px] shrink-0 flex-col border-r border-slate-200 bg-gradient-to-b from-blue-50 to-white px-5 py-6 xl:flex">
            <div className="flex items-center gap-2.5">
              ...
              />
              <span className="text-lg font-black tracking-[-0.02em] text-kedi-navy">
                kedi.media
              </span>
            </div>
                    ...
                    <div className="flex flex-col items-center">
                      <span
                        className={`flex h-8 w-8 items-center justify-center rounded-full border text-sm font-black ${
                          isDone || isActive
                            ? "border-kedi-navy bg-kedi-navy text-white shadow-[0_0_0_5px_rgba(32,16,216,0.12)]"
                ...
                <div className="grid gap-4 lg:grid-cols-3">
                  {upgradePlans.map((plan) => {
                    ...
                    return (
                      ...
                      >
                        {plan.popular && (
                          <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-xl bg-kedi-navy px-4 py-1 text-ui-caption font-black uppercase tracking-wide text-white shadow-md shadow-blue-700/20">
                            Phổ biến
                          </span>
                        )}
                        <div className="flex items-center gap-2">
                          ...
                          {plan.badge && (
                            <span className="rounded-md bg-blue-50 px-2 py-0.5 text-ui-caption font-black text-kedi-navy">
                              {plan.badge}
                            </span>
                          )}
                        </div>
                          ...
                          return (
                            <button
                              ...
                              className={`rounded-lg border px-3 py-2 text-sm font-bold transition ${
                                selected
                                  ? "border-kedi-navy bg-kedi-navy text-white shadow-md shadow-blue-700/20"
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-4 flex items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                          <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-blue-50 text-kedi-navy">
                ...
                <button
                  ...
                  className={`inline-flex min-h-10 items-center justify-center gap-2 rounded-xl px-5 text-sm font-black text-white shadow-md transition ${
                    upgradeStep === 4
                      ...
                      : "bg-kedi-navy shadow-blue-700/25 hover:bg-[#082246]"
                  }`}
                >

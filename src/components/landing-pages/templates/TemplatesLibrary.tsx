          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <div className="relative w-full sm:w-[340px]">
              ...
              <input
                ...
                className="h-10 w-full rounded-lg border border-slate-200 bg-white pl-10 pr-3 text-sm font-medium text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-kedi-yellow dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100"
              />
            </div>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
          {filteredTemplates.map((item) => {
            ...
            return (
              <article
                key={item.id}
                className="group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-0.5 hover:border-kedi-yellow hover:shadow-xl dark:border-slate-800 dark:bg-slate-950"
              >
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <div className="text-ui-caption font-black uppercase tracking-wide text-kedi-navy dark:text-kedi-yellow">{name.code}</div>

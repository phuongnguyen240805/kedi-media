...
function SslBadge({ sslStatus }: { sslStatus: string }) {
  ...
  if (s === "ACTIVE") {
    return (
      <span className="px-2.5 py-0.5 text-ui-micro font-black text-kedi-navy bg-brand-50 dark:text-kedi-yellow dark:bg-kedi-yellow/10 rounded-md tracking-wider">
        ĐÃ BẬT
      </span>
    );
  }

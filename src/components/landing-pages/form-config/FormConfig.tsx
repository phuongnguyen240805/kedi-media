    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-amber-50/50 dark:bg-amber-950/10 border border-amber-100/40 dark:border-amber-900/20 rounded-xl flex items-center justify-between gap-3 text-xs leading-relaxed text-slate-700 dark:text-amber-300">
        <div className="flex items-center gap-2">
          ...
          <span>
            Khám phá ứng dụng <strong className="text-slate-800 dark:text-white">Kedi Automation</strong> và nhận tư vấn chiến lược Gửi Email/Zalo/SMS Tự động từ chuyên gia ngay hôm nay!
          </span>
        </div>
        <a
          href="#"
          className="text-kedi-navy hover:text-kedi-navy dark:text-kedi-yellow dark:hover:text-kedi-yellow font-bold whitespace-nowrap inline-flex items-center gap-0.5 ml-2 cursor-pointer"
        >
                  ...
                  return (
                    <tr
                      ...
                      className={`transition hover:bg-slate-50/50 dark:hover:bg-gray-800/10 ${
                        isSelected ? "bg-[#f4f7ff] dark:bg-kedi-yellow/10" : ""
                      }`}
                    >
                      ...
                      <td className="py-3.5 px-4">
                        <span className="text-sm font-semibold text-slate-800 dark:text-gray-200 hover:text-kedi-navy transition cursor-pointer">
                          {item.name}
                        </span>
                      </td>

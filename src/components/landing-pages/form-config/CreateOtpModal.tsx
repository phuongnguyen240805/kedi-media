            ...
            <div className="text-center space-y-6 max-w-md flex flex-col items-center">
              ...
              <div className="relative w-48 h-36 flex items-center justify-center animate-pulse">
                <svg className="w-full h-full text-amber-400 dark:text-amber-500/80" viewBox="0 0 200 150" fill="none">
                  ...
                  {/* Crying tears */}
                  <path d="M75 90V105" stroke="#FFC629" strokeWidth="3" strokeLinecap="round"/>
                  <path d="M125 90V105" stroke="#FFC629" strokeWidth="3" strokeLinecap="round"/>
                  {/* Sad mouth */}
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-5 py-2.5 text-xs font-bold text-kedi-navy bg-kedi-yellow hover:bg-kedi-yellow rounded-lg shadow-sm transition cursor-pointer"
              >

...
export const BASE_PAGE_TEMPLATE_PRESETS: LandingTemplatePreset[] = [
  ...
  },
  {
    ...
    description: "Khoi carousel anh lon giong mau slide trong builder Kedi.",
    category: "section",
    blocks: [
      {
        type: "carousel",
  ...
  },
  {
    ...
    description: "Menu, hero, grid san pham, FAQ va form chot don lay cam hung tu Kedi Builder.",
    category: "page",
    blocks: [
      {
        type: "menu",

  ...
  return (
    <>
      ...
      {(p.commerceProductId as string) && (
        <div className="mb-3 rounded-lg border border-kedi-yellow/40 bg-brand-50/80 dark:bg-kedi-yellow/10 dark:border-kedi-yellow/30 px-3 py-2 text-[11px] font-medium text-kedi-navy dark:text-kedi-yellow">

...
export const EditorTopBar: React.FC<EditorTopBarProps> = ({
  ...
  return (
    <div className="flex h-16 select-none items-center gap-2 overflow-x-auto border-b border-gray-200 bg-white px-4 shadow-sm">
      ...
      <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg border border-brand-100 bg-brand-50 p-1">
        <Image src="/brand/kedi-icon.png" alt="Kedi.Media" width={24} height={24} className="h-6 w-6 object-contain" />
      </div>

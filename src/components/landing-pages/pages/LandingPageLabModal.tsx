          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-800 dark:text-white tracking-tight flex items-center gap-2">
                ...
                <span className="text-ui-micro px-2 py-0.5 font-bold uppercase rounded-md bg-brand-100 text-kedi-navy dark:bg-brand-950 dark:text-kedi-yellow">
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          {status === "scanning" && (
            <div className="flex flex-col items-center justify-center py-16 text-center space-y-5">
              <div className="relative flex items-center justify-center w-24 h-24">
                <div className="absolute inset-0 rounded-full border-4 border-kedi-yellow/20 animate-ping" />
                <div className="absolute inset-2 rounded-full border-4 border-kedi-yellow/40 animate-pulse" />
                <div className="relative p-5 bg-kedi-yellow text-kedi-navy rounded-full shadow-lg shadow-brand-500/30">
          ...
          {status === "failed" && (
            <div className="flex flex-col items-center justify-center py-12 text-center space-y-4">
              ...
              <button
                ...
                className="mt-2 inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold text-kedi-navy bg-kedi-yellow hover:bg-kedi-yellow rounded-lg shadow-sm transition cursor-pointer"
              >
          ...
          {status === "success" && (
            <>
              ...
              <div className="bg-gray-50/60 dark:bg-gray-800/30 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 flex items-center gap-2">
                    <Gauge className="w-4 h-4 text-kedi-navy" />
              ...
              {/* Footer info banner */}
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-4 rounded-xl bg-brand-50/60 dark:bg-kedi-yellow/10 border border-kedi-yellow/40/60 dark:border-kedi-yellow/30/30 text-xs">
                <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300">
                  <CheckCircle2 className="w-4 h-4 text-kedi-navy dark:text-kedi-yellow flex-shrink-0" />
                  <span>
                ...
                {targetUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 font-semibold text-kedi-navy dark:text-kedi-yellow hover:underline"
                  >

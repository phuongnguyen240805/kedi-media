                  ...
                  return (
                    <tr
                      ...
                      className={`ladi-data-table-row hover:bg-slate-50/80 dark:hover:bg-slate-800/25 ${
                        isSelected ? "bg-brand-50/55 dark:bg-kedi-yellow/5" : ""
                      }`}
                    >
                        ...
                        <div className="space-y-1.5">
                          <div className="flex flex-wrap items-center gap-2">
                            <button
                              type="button"
                              onClick={() => onEdit?.(item)}
                              className="text-left text-sm font-semibold text-slate-900 outline-none transition-colors duration-100 hover:text-kedi-navy focus-visible:text-kedi-navy dark:text-slate-100 dark:hover:text-kedi-yellow"
                            >
                              {item.name}
                            </button>

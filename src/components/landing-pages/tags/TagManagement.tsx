                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4">
                        <span className="inline-block px-2.5 py-0.5 text-xs font-semibold text-kedi-navy bg-brand-50 border border-kedi-yellow/30/40 dark:text-kedi-yellow dark:bg-kedi-yellow/10 rounded-full">
                          {item.name}
                        </span>
                      </td>

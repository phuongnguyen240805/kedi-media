...
export const SubSidebar: React.FC<SubSidebarProps> = ({
  ...
  return (
    <div
      ...
      className="sub-sidebar-scroll relative w-full lg:w-[var(--sub-sidebar-width,185px)] bg-[#f4f4fa] dark:bg-[#13141f] border-r border-gray-200 dark:border-gray-800 flex flex-col flex-shrink-0 h-full overflow-x-hidden p-4"
    >
      <ResizeHandle
      ...
      <div className="flex-1 flex flex-col pt-4 min-h-0">
          ...
          <div className="flex items-center gap-2">
            ...
            {selectedTagId && (
              <button
                ...
                className="text-ui-micro font-semibold text-slate-400 hover:text-kedi-navy dark:hover:text-kedi-yellow cursor-pointer"
              >
                Xóa lọc
              </button>
            )}
        ...
        <div className="relative mb-3 px-1">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 text-sm rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-slate-800 dark:text-gray-100 placeholder-slate-400 focus:outline-hidden focus:border-kedi-yellow"
          />
        </div>

        {/* Tag filter list */}
        <div className="pt-0.5 px-1.5 flex flex-wrap gap-1.5 content-start min-h-0 flex-1 overflow-y-auto overflow-x-hidden">
          <button
            type="button"
            onClick={() => onSelectTag(null)}

  ...
  const handleRegisterConsulting = () => {
    ...
    setTimeout(() => {
      ...
      ladiToast.success({
        ...
        description: "Chuyên gia Kedi sẽ liên hệ lại qua số điện thoại tài khoản của bạn.",
      });
    }, 800);
  };
          ...
          <div className="flex flex-col h-full bg-[#eef3f7] text-slate-800 text-ui-caption font-sans">
            ...
            <div className="flex-1 p-3 overflow-y-auto space-y-3">
              <div className="bg-white p-3 rounded-xl border border-gray-200 shadow-2xs space-y-2">
                ...
                {/* CTA Button */}
                <div className="pt-2">
                  <button className="w-full bg-brand-50 text-kedi-navy font-bold text-center py-1.5 rounded-lg text-ui-nano hover:bg-brand-50 transition">
        ...
        return (
          <div className="flex flex-col h-full bg-white text-slate-800 font-sans text-xs">
            ...
            <div className="bg-white border-b border-gray-100 p-2.5 flex items-center gap-2">
              ...
              <div>
                <div className="font-bold text-ui-micro">Kedi Support</div>
          ...
          <div className="lg:col-span-3 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-550 dark:text-slate-450 leading-relaxed">
                ...
                {" và "}
                <a href="#connect" className="text-kedi-navy dark:text-kedi-yellow font-bold hover:underline">kết nối kênh Zalo/Email</a>.
              </p>
            ...
            <div className="bg-linear-to-r from-brand-50 to-indigo-50 dark:from-kedi-yellow/10 dark:to-indigo-950/20 border border-kedi-yellow/20/60 dark:border-kedi-yellow/30 p-4.5 rounded-2xl space-y-3 shadow-2xs">
              <div className="flex items-center gap-2">

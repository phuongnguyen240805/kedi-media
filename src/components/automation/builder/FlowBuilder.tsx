...
const ACTION_OPTIONS = [
  { id: "send_zalo", name: "Gửi tin nhắn Zalo ZNS", desc: "Gửi tin nhắn OA chính thống chăm sóc khách hàng tự động.", icon: "Z", color: "bg-kedi-yellow", previewType: "zalo" },
...
export const FlowBuilder: React.FC<FlowBuilderProps> = ({
  ...
  const [actionParams, setActionParams] = useState<any>({
    model: "gpt-4o",
    systemPrompt: "Bạn là trợ lý chăm sóc khách hàng thân thiện của Kedi.",
            ...
            {isEditingName ? (
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="p-0.5 text-slate-400 hover:text-kedi-navy cursor-pointer rounded"
                >
        ...
        {activeTab === "list" ? (
          ...
          <div className="flex-1 overflow-auto p-8 flex items-center justify-center bg-slate-50/50 dark:bg-[#0c0d12]">
            <div className="flex flex-col items-center space-y-6">
              ...
              <div className={`w-80 p-5 rounded-2xl border text-center shadow-xs ${
                selectedAction
                  ? "bg-brand-50 dark:bg-kedi-yellow/10 border-kedi-yellow/30 dark:border-kedi-yellow/30"
                  : "bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 border-dashed"
              }`}>
                <div className="text-ui-nano font-extrabold text-kedi-navy dark:text-kedi-yellow uppercase tracking-widest mb-1.5">

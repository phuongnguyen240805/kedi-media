...
export const AutomationSidebar: React.FC<AutomationSidebarProps> = ({
  ...
  return (
    <div
      ...
      className="sub-sidebar-scroll relative w-full lg:w-[var(--sub-sidebar-width,185px)] bg-white dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800 flex flex-col flex-shrink-0 h-full overflow-y-auto overflow-x-hidden py-4 px-2"
    >
      <ResizeHandle
      ...
      <nav className="space-y-0.5 mt-2">
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-2 rounded-lg text-xs font-semibold transition cursor-pointer relative group ${
                isActive
                  ...
                  : "text-slate-700 hover:bg-gray-100 dark:text-slate-400 dark:hover:bg-white/5"
              }`}
            >
              <span className={`${isActive ? "text-kedi-navy dark:text-kedi-yellow" : "text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-400"}`}>
                {item.icon}
              </span>
        ...
        <div>
          <button
            ...
            className={`w-full flex items-center justify-between px-4 py-2 rounded-lg text-xs font-semibold text-slate-700 hover:bg-gray-100 dark:text-slate-400 dark:hover:bg-white/5 transition cursor-pointer group`}
          >
            <div className="flex items-center gap-3">
              <span className="text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-400">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">

      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-kedi-yellow hover:bg-kedi-yellow text-kedi-navy rounded-lg text-sm font-bold shadow-xs hover:shadow-md transition cursor-pointer"
          >
            <IconPlus size={16} />
            <span>Tạo Flow</span>
          </button>
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50 py-1">
              <button
                ...
                className="w-full text-left px-4 py-2 text-sm text-slate-700 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition cursor-pointer flex items-center gap-2"
              >
              ...
              <button
                ...
                className="w-full text-left px-4 py-2 text-sm text-slate-700 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition cursor-pointer flex items-center gap-2"
              >
                <svg className="w-4 h-4 text-kedi-yellow" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
                </svg>
                <span>Tạo Flow</span>
              </button>
              <label className="w-full text-left px-4 py-2 text-sm text-slate-700 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition cursor-pointer flex items-center gap-2">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-4 rounded-xl shadow-2xs">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-sm bg-gray-50/50 dark:bg-gray-800/40 border border-gray-200 dark:border-gray-800 focus:border-kedi-yellow rounded-lg outline-hidden text-slate-800 dark:text-white"
          />
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-900 bg-gray-50/50 dark:bg-gray-800/10">
                ...
                <th className="py-3.5 px-6 text-xs font-bold text-slate-900 dark:text-slate-200 tracking-wider w-36">
                  Trạng thái
                </th>
                <th className="py-3.5 px-6 text-xs font-bold text-slate-900 dark:text-slate-200 tracking-wider w-48">
                  Loại Trigger
                </th>
                <th className="py-3.5 px-6 text-xs font-bold text-slate-900 dark:text-slate-200 tracking-wider w-48">
                  Ngày tạo
                </th>
                <th className="py-3.5 px-6 text-xs font-bold text-slate-900 dark:text-slate-200 tracking-wider w-32 text-right">
                  Hành động
                </th>
              </tr>
            </thead>
                  ...
                  >
                    <td className="py-4 px-6">
                      <button
                        ...
                        className="text-sm font-bold text-kedi-navy dark:text-kedi-yellow hover:underline text-left cursor-pointer"
                      >
                        {flow.name}
                      </button>
                    </td>
                    <td className="py-4 px-6">
                      ...
                      >
                        <span className={`w-1.5 h-1.5 rounded-full ${flow.status === "ACTIVE" ? "bg-green-650" : "bg-gray-500"}`} />
                        <span>{flow.status === "ACTIVE" ? "Đang chạy" : "Tạm ngưng"}</span>
                      </button>
                    </td>
                    <td className="py-4 px-6 text-sm text-slate-700 dark:text-slate-400">
                    ...
                    <td className="py-4 px-6 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="p-1.5 text-slate-500 hover:text-kedi-navy dark:text-slate-500 dark:hover:text-kedi-yellow hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md cursor-pointer transition"
                        >
                          <IconEdit size={16} />
                        </button>
                        <button
                          ...
                          title="Xóa kịch bản"
                          className="p-1.5 text-slate-500 hover:text-red-650 dark:text-slate-500 dark:hover:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md cursor-pointer transition"
                        >
                          <IconTrash size={16} />
                        </button>
                      </div>
                ...
                <tr>
                  <td colSpan={5} className="py-20 text-center">
                    <div className="flex flex-col items-center justify-center max-w-sm mx-auto">
                      ...
                      <div className="w-16 h-16 bg-brand-50 dark:bg-kedi-yellow/10 text-kedi-yellow rounded-full flex items-center justify-center mb-4">
                      ...
                      <button
                        onClick={handleCreateNew}
                        className="mt-5 flex items-center gap-1.5 px-4 py-2 bg-kedi-yellow hover:bg-kedi-yellow text-kedi-navy rounded-lg text-xs font-bold shadow-2xs transition cursor-pointer"
                      >
                        <IconPlus size={14} />

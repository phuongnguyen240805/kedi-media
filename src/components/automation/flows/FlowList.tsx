      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-kedi-yellow hover:bg-kedi-yellow text-white rounded-lg text-sm font-bold shadow-xs hover:shadow-md transition cursor-pointer"
          >
            <IconPlus size={16} />
            <span>Tạo Flow</span>
          </button>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-4 rounded-xl shadow-2xs">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-sm bg-gray-50/50 dark:bg-gray-800/40 border border-gray-200 dark:border-gray-750 focus:border-kedi-yellow rounded-lg outline-hidden text-slate-800 dark:text-white"
          />
        </div>
                    ...
                    <td className="py-4 px-6 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="p-1.5 text-slate-500 hover:text-kedi-navy dark:text-slate-450 dark:hover:text-kedi-yellow hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md cursor-pointer transition"
                        >
                          <IconEdit size={16} />
                        </button>
                        <button
                ...
                <tr>
                  <td colSpan={5} className="py-20 text-center">
                    <div className="flex flex-col items-center justify-center max-w-sm mx-auto">
                      ...
                      <button
                        onClick={handleCreateNew}
                        className="mt-5 flex items-center gap-1.5 px-4 py-2 bg-kedi-yellow hover:bg-kedi-yellow text-white rounded-lg text-xs font-bold shadow-2xs transition cursor-pointer"
                      >
                        <IconPlus size={14} />

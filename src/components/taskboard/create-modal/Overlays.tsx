  ...
  return (
    <>
      {restorePromptOpen && selectedRestoreDraft && (
        <div
          className="fixed inset-0 z-[200000] flex items-center justify-center bg-kedi-navy/65 p-4"
      ...
      {submitWithoutProjectPromptOpen && (
        <div
          className="fixed inset-0 z-[200000] flex items-center justify-center bg-kedi-navy/70 p-4"

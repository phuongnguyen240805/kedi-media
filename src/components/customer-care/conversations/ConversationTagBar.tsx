      ...
      <div className="flex h-8 items-center gap-2">
        ...
        <div ref={menuRef} className="relative shrink-0 self-start pt-0.5">
          <button
            ...
            className="flex h-[24px] items-center gap-1 rounded-md border border-slate-200 bg-white px-2 text-[10px] font-semibold text-slate-600 shadow-sm transition hover:border-kedi-yellow hover:bg-brand-50 hover:text-kedi-navy dark:border-white/10 dark:bg-white/[0.05] dark:text-slate-300 dark:hover:bg-kedi-yellow/10 dark:hover:text-kedi-yellow"
                  ...
                  return (
                    ...
                    >
                      ...
                      {busy ? (
                        ...
                        <Check className="h-3.5 w-3.5 text-kedi-navy" />
                      ) : null}
                    </button>
                  );
                })}

  ...
  return (
    <button
      ...
      className={`relative inline-flex h-7 w-12 shrink-0 items-center rounded-full transition-colors ${
        checked ? "bg-kedi-yellow" : "bg-slate-200 dark:bg-[#2b3130]"
  ...
  return (
    <label className={`relative inline-flex min-w-[120px] ${className}`}>
      <select
        ...
        className="h-10 w-full appearance-none rounded-lg border border-slate-300 bg-white px-3 pr-9 text-sm font-medium text-slate-700 outline-none transition focus:border-kedi-yellow dark:border-white/10 dark:bg-[#161b1a] dark:text-slate-200"
      >
...
export function SettingsButton({
  ...
  const styles = {
    primary: "bg-kedi-yellow text-slate-950 hover:bg-kedi-yellow",
    ...
    ghost: "text-kedi-navy hover:bg-kedi-yellow/10 dark:text-kedi-yellow",

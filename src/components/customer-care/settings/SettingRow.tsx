...
export function ControlledSwitch({
  ...
  return (
    <button
      ...
      className={`relative inline-flex h-6 w-11 items-center rounded-full transition ${checked ? "bg-kedi-yellow" : "bg-slate-200 dark:bg-white/10"} disabled:cursor-not-allowed`}
    >

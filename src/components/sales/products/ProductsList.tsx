      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-gray-200 dark:border-gray-900 pb-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-bold text-[#3a5680] bg-kedi-yellow hover:bg-[#e0a800] rounded-lg shadow-sm transition cursor-pointer"
          >
            + Tạo sản phẩm
          </button>
        </div>
        ...
        {filteredProducts.length > 0 && (
          <div className="flex items-center justify-between border-t border-gray-200 dark:border-gray-900 p-4 bg-gray-50/20 dark:bg-gray-900/10">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button className="flex items-center justify-center w-7 h-7 rounded-md bg-kedi-yellow text-[#3a5680] font-bold text-xs cursor-pointer">1</button>
              <button className="flex items-center justify-center w-7 h-7 rounded-md border border-gray-200 dark:border-gray-800 text-slate-400 cursor-pointer hover:text-slate-700 transition">

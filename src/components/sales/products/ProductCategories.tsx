        ...
        <form onSubmit={handleSave} className="px-6 pb-6 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-stretch gap-3">
              {/* Drop zone */}
              <div className="w-20 h-[72px] border-2 border-dashed border-gray-250 dark:border-gray-700 rounded-lg flex flex-col items-center justify-center gap-1 cursor-pointer hover:border-lime-400 hover:bg-brand-50/40 dark:hover:bg-lime-950/20 transition select-none text-slate-400 flex-shrink-0">

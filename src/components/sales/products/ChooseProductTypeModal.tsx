...
const DigitalIcon = () => (
  <svg className="w-7 h-7" viewBox="0 0 32 32" fill="none">
    ...
    <path d="M8 20c0-3 2-5 4.5-5.5.5-3 3-5 5.5-5 3.5 0 6 2.5 6 6 0 .3 0 .6-.1.9C25.3 17 26 18 26 19c0 1.7-1.3 3-3 3H10c-1.1 0-2-.9-2-2z" stroke="#FFC629" strokeWidth="1.8" strokeLinejoin="round"/>
    <path d="M14 22l2 2 2-2" stroke="#FFC629" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
    <line x1="16" y1="19" x2="16" y2="24" stroke="#FFC629" strokeWidth="1.8" strokeLinecap="round"/>
  </svg>
);

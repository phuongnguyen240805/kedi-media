        ...
        <form onSubmit={handleSave} className="px-6 pb-6 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full px-3 py-2.5 text-xs rounded-lg border border-gray-300 dark:border-gray-800 bg-white dark:bg-gray-900 text-slate-800 dark:text-gray-100 placeholder-slate-400 focus:outline-none focus:border-brand-400 font-medium font-mono"
              required
            />
    ...
    <div className="space-y-5 flex-1">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-gray-200 dark:border-gray-900 pb-5">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-bold text-[#3a5680] bg-kedi-yellow hover:bg-[#e0a800] rounded-lg shadow-sm transition cursor-pointer whitespace-nowrap"
        >
          + Tạo trường mới
        </button>
      </div>
                ...
                <tr>
                  <td colSpan={5} className="py-24 text-center select-none">
                    <div className="flex flex-col items-center justify-center space-y-3">
                      ...
                      <button
                        onClick={() => setIsModalOpen(true)}
                        className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-bold text-[#3a5680] bg-kedi-yellow hover:bg-[#e0a800] rounded-lg shadow-sm transition cursor-pointer"
                      >
                        + Tạo trường mới
                      </button>
                    </div>
